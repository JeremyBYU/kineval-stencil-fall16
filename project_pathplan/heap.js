...
(function (exports) {
   ...
   * @returns {void}
   */
  exports.insert = function insert (heap, new_element, type = HEAP_TYPE) {
   ...
   */
  exports.extract = function extract (heap, type = HEAP_TYPE) {
    let parent_index = 0
...
})(typeof exports === 'undefined' ? this[ 'heap' ] = {} : exports);
